...
public class GameManager : MonoBehaviour
{
	...
	private void Start()
	{
		Player.Instance.Initialize(
			name: Player.Instance.baseName,
			health: Player.Instance.baseHealth,
			strenght: Player.Instance.baseStrenght,
			armor: Player.Instance.baseArmor,
			level: Player.Instance.baseLevel,
			xp: Player.Instance.baseXp,
			maxXp: Player.Instance.baseMaxXp);
		UpdatePlayerStats();
